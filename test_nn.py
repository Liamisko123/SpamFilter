...
print(network.get_prediction(data4))
...
for i in range(iters):
    ...
    network.propagate_forward(data4)
    network.propagate_backwards(desired_output4)
...
network.propagate_forward(data4)
print(f"got {network.get_output():.4f}\twant: {desired_output4}")
